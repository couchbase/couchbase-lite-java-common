...
#include <jni.h>
/* Header for class com_couchbase_lite_internal_core_C4Document */

#ifndef _Included_com_couchbase_lite_internal_core_C4Document
#define _Included_com_couchbase_lite_internal_core_C4Document
#ifdef __cplusplus
extern "C" {
#endif
