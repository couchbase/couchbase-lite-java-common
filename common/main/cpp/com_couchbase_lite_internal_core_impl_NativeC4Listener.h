 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_couchbase_lite_internal_core_impl_NativeC4Listener_free
  (JNIEnv *, jclass, jlong);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_couchbase_lite_internal_core_impl_NativeC4Listener_getUrls
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_couchbase_lite_internal_core_impl_NativeC4Listener_getPort
  (JNIEnv *, jclass, jlong);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_couchbase_lite_internal_core_impl_NativeC4Listener_getConnectionStatus
  (JNIEnv *, jclass, jlong);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_couchbase_lite_internal_core_impl_NativeC4Listener_getUriFromPath
