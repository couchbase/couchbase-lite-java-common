 ...
 */
public final class FileLogSink extends AbstractLogSink {
    ...
    @Override
    public int hashCode() { return Objects.hash(getLevel(), directory, maxKeptFiles, maxFileSize); }
    ...
    public boolean similar(@Nullable FileLogSink other) {
        return (other != null)
